...
parser.add_argument('--viewer', default='rviz', help='viewer to use (rviz or interactivemarker or blank for none)')
parser.add_argument('--env', help='environment file to load')
args = parser.parse_args()

openravepy.RaveInitialize(True, level=openravepy.DebugLevel.Debug)
openravepy.misc.InitOpenRAVELogging()

env, robot = adapy.initialize(attach_viewer=args.viewer if args.viewer else None, sim=args.sim, env_path=args.env)
manip = robot.arm
